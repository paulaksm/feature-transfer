...
Since MobileNet architecture consists of 13 depthwise separable convolutional blocks, 1 regular convolutional layer and 1 fully-connected and softmax layer, we will consider <dd> n &#8712; [1, 12]</dd>.
