...
+ __baseB__ - MobileNet model, with weights initialized randomly trained on a balanced [self-driving dataset](https://github.com/paulaksm/self_driving_data) (3 categories and 40k images)
